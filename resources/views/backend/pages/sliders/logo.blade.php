                ...
                <div class="modal-body">
                  <form action="{!! route('admin.slider.store') !!}"  method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label for="title">logo Title <small class="text-danger">(required)</small></label>
                    ...
                    <div class="form-group">
                      <label for="b_type"> Type <small class="text-info">type</small></label>
                      {{-- <input type="url" class="form-control" name="b_type" id="b_type" placeholder=" banner type"> --}}
                      <select class="form-control" name="b_type" id="b_type" placeholder=" image type">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="title" id="title" placeholder=" Title" required value="{{ $slider->title }}">
                        </div>
                        ...
                        {{-- <div class="form-group">
                          <label for="button_text"> Button Text <small class="text-info">(optional)</small></label>
                          <input type="text" class="form-control" name="button_text" id="button_text" placeholder=" Button Text (if need)"  value="{{ $slider->button_text }}">
                        </div> --}}

                        <div class="form-group">
                          {{-- <label for="button_link"> Button Link <small class="text-info">(optional)</small></label> --}}
                          {{-- <input type="url" class="form-control" name="button_link" id="button_link" placeholder=" Button Text (if need)"  value="{{ $slider->button_link }}"> --}}
                        </div>
                        <label for="b_type"> Type <small class="text-info">type</small></label>
                        {{-- <input type="url" class="form-control" name="b_type" id="b_type" placeholder=" banner type"> --}}
                        ...
                        <div class="form-group">
                          <label for="priority"> Priority <small class="text-info">(required)</small></label>
                          <input type="number" class="form-control" name="priority" id="priority" placeholder=" Priority; e.g: 10" required  value="{{ $slider->priority }}">
                        </div>
