            ...
            <div class="container">
                <div class="row">
					<div class="col-md-4 col-sm-8 col-xs-12">
											<a href="" title="Lira textile."><img class="site-logo" src="{{ asset('/frontend/wp-content/uploads/Logo.png') }}" alt="Lira textile." /></a>
																</div>
...
<li id="menu-item-39" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-39"><a href="{{ route('contact') }}">Contacts</a></li>
	...
	<div class="sydney-hero-area">
			...
			<div class="overlay"></div>																<img class="header-inner" src="{{ asset('/frontend/wp-content/uploads/cropped-united-nations-runway-3.jpg') }}" width="1920" alt="" title="">
									</div>
	...
	<h3 class="archive-title">Women Products</h3>
	</header>
