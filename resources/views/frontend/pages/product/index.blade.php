...
<link rel="alternate" type="application/rss+xml" title="JDK Group Ltd. &raquo; Feed" href="" />
<link rel="alternate" type="application/rss+xml" title="JDK Group Ltd. &raquo; Comments Feed" href="" />
<link rel="alternate" type="application/rss+xml" title="JDK Group Ltd. &raquo; Products Feed" href="" />
            ...
            <div class="container">
                <div class="row">
					<div class="col-md-4 col-sm-8 col-xs-12">
											<a href="../index.html" title="Lira textile."><img class="site-logo" src="{{ asset('/frontend/wp-content/uploads/Logo.png') }}" alt="Lira textile." /></a>
																</div>
					<div class="col-md-8 col-sm-4 col-xs-12">
						<div class="btn-menu"><i class="sydney-svg-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M16 132h416c8.837 0 16-7.163 16-16V76c0-8.837-7.163-16-16-16H16C7.163 60 0 67.163 0 76v40c0 8.837 7.163 16 16 16zm0 160h416c8.837 0 16-7.163 16-16v-40c0-8.837-7.163-16-16-16H16c-8.837 0-16 7.163-16 16v40c0 8.837 7.163 16 16 16zm0 160h416c8.837 0 16-7.163 16-16v-40c0-8.837-7.163-16-16-16H16c-8.837 0-16 7.163-16 16v40c0 8.837 7.163 16 16 16z" /></svg></i></div>
						<nav id="mainnav" class="mainnav" role="navigation">
							<div class="menu-main-menu-container"><ul id="menu-main-menu" class="menu">
                                <li id="menu-item-44" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-42 current_page_item menu-item-44">
                                    <a href="{{ route('home') }}" aria-current="page">Home</a></li>
...
<li id="menu-item-40" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item current_page_item menu-item-40"><a href="{{ route('product') }}" aria-current="page">Products</a></li>
<li id="menu-item-39" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-39"><a href="{{ route('contact') }}">Contacts</a></li>
	...
	<div class="sydney-hero-area">
			...
			<div class="overlay"></div>	<img class="header-inner" src="{{ asset('/frontend/wp-content/uploads/cropped-united-nations-runway-3.jpg') }}" width="1920" alt="JDK Group Ltd." title="JDK Group Ltd.">
									</div>
	...
	<div id="content" class="page-wrap">
		<div class="container content-wrapper">
			<div class="row">	<div id="primary" class="content-area col-md-9"><main id="main" class="site-main" role="main">
                <nav class="woocommerce-breadcrumb"><a href="">Home</a>&nbsp;&#47;&nbsp;Products</nav>
                <header class="woocommerce-products-header">
	<h3 class="archive-title">Products</h3>
	</header>
...
<ul class="products columns-4">
	...
	<li class="product type-type-product post-431 status-publish instock product_cat-men product_tag-denim has-post-thumbnail shipping-taxable product-type-simple" style="float: left; width: 21.05%;">
		<a href="" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
			<div class="yith-placeholder"></div>
			<img width="300" height="400" src="{{ asset('img/sliders/'.$slider->image) }}" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" loading="lazy"  sizes="(max-width: 300px) 100vw, 300px" />
	...
	<aside id="woocommerce_product_categories-2" class="widget woocommerce widget_product_categories">
        <h3 class="widget-title">Product categories</h3><ul class="product-categories">
            <li class="cat-item cat-item-24">
                <a href="{{ route('product-category-man') }}">Men</a> 
                <span class="count">(3)</span>
            </li>
<li class="cat-item cat-item-26">
    <a href="{{ route('product-category-women') }}">Women</a> 
...
<script type='text/javascript' src='{{ asset('/frontend/wp-content/plugins/contact-form-7-style/js/frontend-min20f0.html?ver=3.1.9') }}' id='cf7-style-frontend-script-js'></script>
...
<script type='text/javascript' src='{{ asset('/frontend/wp-content/plugins/contact-form-7/includes/js/scriptsde54.html?ver=5.3') }}' id='contact-form-7-js'></script>
<script type='text/javascript' src='{{ asset('/frontend/wp-content/plugins/google-language-translator/js/scripts8bc9.js?ver=6.0.7') }}' id='scripts-js'></script>
<script type='text/javascript' src='{{ asset('/frontend/../translate.google.com/translate_a/elementcd15.html?cb=GoogleLanguageTranslatorInit') }}' id='scripts-google-js'></script>
...
<script type='text/javascript' src='{{ asset('/frontend/wp-content/plugins/woocommerce/assets/js/frontend/woocommerce.min1c9b.js?ver=4.6.1') }}' id='woocommerce-js'></script>
...
<script type='text/javascript' src='{{ asset('/frontend/wp-content/plugins/woocommerce/assets/js/frontend/cart-fragments.min1c9b.js?ver=4.6.1') }}' id='wc-cart-fragments-js'></script>
<script type='text/javascript' src='{{ asset('/frontend/wp-content/themes/sydney/js/scriptsd03b.js?ver=5.5.1') }}' id='sydney-scripts-js'></script>
<script type='text/javascript' src='{{ asset('/frontend/wp-content/themes/sydney/js/main2e1f.js?ver=20200504') }}' id='sydney-main-js'></script>
<script type='text/javascript' src='{{ asset('/frontend/wp-content/themes/sydney/js/so-legacyd03b.js?ver=5.5.1') }}' id='sydney-so-legacy-scripts-js'></script>
<script type='text/javascript' src='{{ asset('/frontend/wp-content/themes/sydney/js/so-legacy-maind03b.js?ver=5.5.1') }}' id='sydney-so-legacy-main-js'></script>
<script type='text/javascript' id='wce_frontend_js-js-extra'>
/* <![CDATA[ */
var catalog_enquiry_front = {"ajaxurl":"","settings":{"is_page_redirect":"Enable","redirect_page_id":"480","custom_static_heading":"","name_label":"Your Name","email_label":"Your Email","subject_label":"Subject of Enquiry","phone_label":"Your Cellphone Number","address_label":"Give Your Address","comment_label":"Your Message","fileupload_label":"Upload File (Maximum 2MB)","captcha_label":"","captcha_input_label":"","is_captcha":"Enable","is_enable":"Enable","for_user_type":"3","other_emails":"","top_content_form":"","bottom_content_form":"","is_enable_enquiry":"Enable","button_type":"0","button_link":"","button_text":"","button_text_color":"fbfbfb","button_background_color":"fbfbfb","button_text_color_hover":"fbfbfb","button_background_color_hover":"fbfbfb","button_border_color":"fbfbfb","is_subject":"Enable","is_phone":"Enable","is_address":"Enable","is_comment":"Enable","is_fileupload":"Enable","filesize_limit":"2","other_admin_mail":""},"error_levels":{"name_required":"Name is required field","email_required":"Email is required field","email_valid":"Please Enter Valid Email Id","captcha_required":"Please enter the security code","captcha_valid":"Please enter the valid seurity code","ajax_error":"Error in system please try later","filetype_error":"Invalid file format.","filesize_error":"Exceeded filesize limit."},"ajax_success_msg":"Enquiry sent successfully","redirect_link":"https:\/\/www.jdkfashion.com\/enquiry\/","captcha":"A30OIG8Y"};
/* ]]> */
</script>
<script type='text/javascript' src='{{ asset('/frontend/wp-content/plugins/woocommerce-catalog-enquiry/assets/frontend/js/frontendee9a.js?ver=3.2.2') }}' id='wce_frontend_js-js'></script>
<script type='text/javascript' src='{{ asset('/frontend/wp-includes/js/wp-embed.mind03b.js?ver=5.5.1') }}' id='wp-embed-js'></script>
